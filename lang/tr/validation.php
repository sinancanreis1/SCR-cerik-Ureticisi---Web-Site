...
return [
    ...
    'unique' => ':attribute (Bu URL) daha önceden kayıt edilmiş. Lütfen farklı bir isim veya URL seçin.',
    ...
    'custom' => [
        'slug' => [
            'unique' => 'Bu Sayfa Linki (URL) daha önceden kullanılmış. Lütfen URL sonuna bir ek veya sayı ekleyin (örn: deneme-kategori-1).',
        ],
    ],
