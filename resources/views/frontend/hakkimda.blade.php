...
@section('title', 'Hakkımda | Sinan Can REİS')
@section('meta_description', 'Sinan Can REİS kimdir? Bilişim, yazılım, teknoloji ve bilim alanlarındaki dijital gelişim serüvenim ve hakkımda merak ettikleriniz.')
