        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-5">
                <div class="contact-form-area has-shadow p-5 rounded-4" style="background: #ffffff; border: 1px solid #e5e7eb;">
                    <h2 class="title text-center mb-4" style="color: #030712;">Giriş Yap</h2>
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="text-center mt-2">
                            <button type="submit" class="btn px-5 py-3" style="background: #661414; color: #ffffff; border: none; font-size: 1.1rem; font-weight: 600; border-radius: 50px; letter-spacing: 0.5px; min-width: 200px; display: inline-flex; align-items: center; justify-content: center;">Giriş Yap</button>
                        </div>
                    </form>
                    
                    <div class="text-center mt-4 pt-3 border-top" style="border-color: #e5e7eb !important;">
                        <span style="color: #6b7280;">Hesabınız yok mu?</span>
                        <a href="{{ route('register') }}" class="fw-bold ms-1" style="color: #661414; text-decoration: underline;">Kayıt Ol</a>
                    </div>
                </div>
            </div>
        </div>
